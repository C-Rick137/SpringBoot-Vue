...
function e(e2) {
  return function(e3) {
    if (Array.isArray(e3)) {
      for (var t2 = 0, o = new Array(e3.length); t2 < e3.length; t2++) o[t2] = e3[t2];
      return o;
    }
  }(e2) || function(e3) {
...
var u = { enableBodyScroll: function(e2) {
  if (r) {
    if (!e2) return void console.error("enableBodyScroll unsuccessful - targetElement must be provided when calling enableBodyScroll on IOS devices.");

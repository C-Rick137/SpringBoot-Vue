<template>
    <div>
        ...
        <el-dialog v-model="data.formVisible" destroy-on-close title="员工信息" width="500">
            <el-form ref="formRef" :model="data.form" :rules="data.rules" label-width="80px"
                ...
                <el-form-item label="部门">
                    <el-select v-model="data.form.departmentId" style="width: 100%">
                        <el-option v-for="item in data.departmentList" :key="item.id" :label="item.name"
